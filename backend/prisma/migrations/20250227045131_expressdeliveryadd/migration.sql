...
INSERT INTO "new_LineOfCreditApplication" ("amount", "createdAt", "id", "status", "updatedAt", "user_id") SELECT "amount", "createdAt", "id", "status", "updatedAt", "user_id" FROM "LineOfCreditApplication";
